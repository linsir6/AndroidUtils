package com.linsir.okhttputil.log;
    ...
    private Response logForResponse(Response response) {
        try {
            ...
            if (!TextUtils.isEmpty(clone.message())){
                Log.e(tag,"messag : " + clone.message());
            }
    ...
    private void logForRequest(Request request) {
        try {
            ...
            if (requestBody != null) {
                ...
                if (mediaType != null) {
                    Log.e(tag, "requestBody's cotentType " + mediaType.toString());
                    if (isText(mediaType)) {
